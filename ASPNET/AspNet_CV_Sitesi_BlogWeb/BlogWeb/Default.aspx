        ...
        <div class="my-auto">
          ...
          <div class="resume-item d-flex flex-column flex-md-row mb-5">
            <div class="resume-content mr-auto">
              ...
              <div>
                  <asp:Label ID="Label13" runat="server" Text='<%#Eval("ACIKLAMA") %>'></asp:Label> - AGNO: <asp:Label ID="Label14" runat="server" Text='<%#Eval("GENELNOT") %>'></asp:Label></div>
            </div>
            <div class="resume-date text-md-right">
              <span class="text-primary">
            ...
            <asp:Repeater ID="Repeater4" runat="server">
              ...
              <ul class="fa-ul mb-0">
                <li><i class="fa-li fa fa-check"></i>
                    <asp:Label ID="Label16" runat="server" Text='<%#Eval("YETENEK") %>'></asp:Label></li>
              </ul>
        ...
        <div class="my-auto">
          <h2 class="mb-5">HOBİLERİM</h2>
            <asp:Repeater ID="Repeater5" runat="server">
                ...
                <ul class="fa-ul mb-0">
                    <li><i class="fa-li fa fa-check"></i>
                        <asp:Label ID="Label16" runat="server" Text='<%#Eval("HOBI") %>'></asp:Label></li>
              </ul>
            </ItemTemplate>
          </asp:Repeater> 
        </div>
